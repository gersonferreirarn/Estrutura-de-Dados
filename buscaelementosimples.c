...
int main(){
	...
	FILE *arquivo = fopen("buscasimples_aleatorio_caso.txt", "a");
...
int search(int *v, int n, int x){ // so funciona para um vetor de ordenado crescente
	for(int i=0; i<n; i++){
		if(v[i] == x){
			return i;
		}
